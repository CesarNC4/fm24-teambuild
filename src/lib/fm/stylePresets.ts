...
export const STYLE_PRESETS: StylePreset[] = [
  ...
  },
  {
    ...
    signature: [{ codes: ["PF"], label: "Delantero presionante" }, { codes: ["BWM"], label: "Recuperador" }, { codes: ["SK"], label: "Portero líbero" }],
  ...
  },
  {
    ...
    signature: [{ codes: ["HB"], label: "Medio escoba que forma la línea de tres" }, { codes: ["PF"], label: "Delantero presionante" }, { codes: ["B2B", "CM"], label: "medios que llegan como tercer hombre" }, { codes: ["SK"], label: "Portero líbero" }],
    manMarking: true,
    ...
    evolution: [
      ...
      { kind: "role", codes: ["HB"], label: "Medio escoba" },
  ...
  },
  {
    ...
    signature: [{ codes: ["PF"], label: "dos Delanteros presionantes" }, { codes: ["BWM"], label: "Recuperador" }, { codes: ["REG", "DLP"], label: "Regista con «Entrar más duro»" }, { codes: ["CWB", "WB"], label: "laterales completos que dan la anchura" }],
  ...
  },
  {
    ...
    signature: [{ codes: ["AM", "AP", "SS"], label: "dos mediapuntas" }, { codes: ["CWB", "WB"], label: "carrileros que hacen de extremo" }, { codes: ["BPD"], label: "central con salida en el medio" }, { codes: ["DLP", "B2B"], label: "pivote y medio que llega" }],
  ...
  // =========================================================== Posesión
  {
    ...
    signature: [{ codes: ["DLP", "RPM", "REG"], label: "organizador en la base" }, { codes: ["BPD"], label: "central con salida" }, { codes: ["SK"], label: "Portero líbero" }],
    levers: [
  ...
  },
  {
    ...
    signature: [{ codes: ["RPM", "DLP", "REG"], label: "organizador" }, { codes: ["F9", "CF"], label: "Falso nueve o Delantero completo" }, { codes: ["BPD"], label: "central con salida" }],
    levers: [],
    evolution: [],
  },
  {
  ...
  },
  {
    ...
    principles: [
      ...
      "Sin «Salir jugando desde la defensa»: en FM acaba en pelotazo por frustración; lo sustituyen Central con salida, ritmo bajo y pase corto",
    ...
    signature: [
      ...
      { codes: ["DM"], label: "MCD en apoyo (mejor que el Organizador retrasado, que roba espacio al Mezzala)" },
      { codes: ["IFB", "IWB", "FB"], label: "lateral que cierra (invertido o en apoyo con «Mantener posición» + «Cerrarse»)" },
      { codes: ["BPD"], label: "Central con salida: stopper por el lado de la sobrecarga, cobertura por el débil" },
      { codes: ["AF", "DLF"], label: "Delantero avanzado (clava a los centrales) o retrasado" },
    ],
  ...
  },
  {
    ...
    posesion: 2, forma: "4-2-4 / 2-4-4", motor: "medio-cond", motorNote: "Exige Serenidad ≥ 14 en portero, centrales y pivotes; compensar «Salir jugando» con Central con salida y ritmo mínimo.",
    signature: [{ codes: ["SK"], label: "Portero líbero en apoyo (tercer central)" }, { codes: ["BPD"], label: "Central con salida" }, { codes: ["DLP", "DM"], label: "doble pivote con pase corto" }, { codes: ["AM"], label: "Mediapunta libre con «Variar la posición»" }, { codes: ["PF"], label: "Delantero presionante en apoyo" }],
    mobileRoles: ["AM"],
  ...
  },
  {
    ...
    signature: [{ codes: ["RPM", "REG"], label: "organizador móvil o Regista" }, { codes: ["B2B", "WM"], label: "Box-to-box e Interior con «Variar la posición»" }, { codes: ["CWB", "WB"], label: "carrileros con «Regatear más»" }, { codes: ["CF", "F9", "DLF"], label: "delantero que baja y rota" }],
  ...
  },
  {
    ...
    description: "Cualquiera ocupa la posición del compañero que se mueve; el campo se hace grande con balón y pequeño sin él; línea muy alta con portero líbero y un central que sube.",
    mentality: "Ofensiva", mentalityId: "atacante",
    ...
    when: "Plantillas con seis o más polivalentes, centrales con Velocidad ≥ 14 y un portero líbero.",
    family: "posesion", parent: "tiki-taka", origin: "Michels y Cruyff (Ajax, Holanda 74) · Magicomonta lo recrea en 3-4-3 rombo / 3-3-3-1",
    principles: ["Intercambio de posiciones constante", "Presión altísima con Adelantarse más para hacer el campo pequeño", "Líbero en apoyo entre dos centrales de cobertura"],
    ...
    signature: [{ codes: ["L"], label: "Líbero en apoyo" }, { codes: ["SK"], label: "Portero líbero en ataque" }, { codes: ["AP", "EG"], label: "Organizador avanzado o Enganche" }, { codes: ["F9", "CF"], label: "Falso nueve o Delantero completo" }],
    ...
    evolution: [
      ...
      { kind: "role", codes: ["SK"], label: "Portero líbero" },
    ],
  },
  {
    id: "control-directo",
  ...
  },
  {
    ...
    signature: [{ codes: ["DLP", "REG"], label: "organizador en la base del rombo" }, { codes: ["CAR", "MEZ"], label: "Carrilero interior y Mezzala" }, { codes: ["AM", "SS", "EG"], label: "enganche o segundo delantero" }, { codes: ["WB", "FB", "CWB"], label: "laterales que dan la anchura" }],
  ...
  },
  {
    ...
    signature: [{ codes: ["CD"], label: "dos Defensas centrales en defender" }, { codes: ["WM"], label: "Interior en apoyo por dentro" }, { codes: ["CM", "DM", "BWM"], label: "medio en defender" }, { codes: ["B2B"], label: "Box-to-box" }, { codes: ["DLF"], label: "Delantero retrasado" }, { codes: ["AF", "P"], label: "punta rápido" }],
  ...
  },
  {
    ...
    weaknesses: ["La directiva se quejará del «fútbol directo»", "Sin Recuperador que destruya en el centro, se abre", "Contra rivales iguales o superiores hay que bajar a Equilibrada"],
    when: "Cualquier nivel: Recuperador, Delantero presionante y puntas con Velocidad ≥ 15.",
    ...
    signature: [{ codes: ["CD", "BPD"], label: "Central en defender; con salida mejor que Sin florituras" }, { codes: ["BWM"], label: "Recuperador en apoyo como destructor" }, { codes: ["B2B", "SV"], label: "Box-to-box o Segundo volante como enlace" }, { codes: ["PF"], label: "Delantero presionante (mejor que el Avanzado)" }, { codes: ["FB", "CWB", "WB"], label: "laterales en defender (ligas menores) o completos (élite)" }],
    ...
    evolution: [
      { kind: "role", codes: ["BWM"], label: "Recuperador" },
      { kind: "role", codes: ["PF"], label: "Delantero presionante" },
  ...
  // =========================================================== Directo y bandas
  {
    ...
    signature: [{ codes: ["TF", "WTF"], label: "Delantero referencia" }, { codes: ["DW", "WM"], label: "bandas que trabajan" }],
    levers: [],
    evolution: [{ kind: "role", codes: ["TF", "WTF"], label: "un Delantero referencia" }],
  },
  {
    id: "bandas",
  ...
  },
  {
    ...
    signature: [{ codes: ["WCB"], label: "Central abierto que conduce" }, { codes: ["CWB"], label: "dos Carrileros completos" }, { codes: ["TF", "DLF"], label: "referencia o Delantero retrasado" }, { codes: ["AF", "SS"], label: "punta móvil" }],
