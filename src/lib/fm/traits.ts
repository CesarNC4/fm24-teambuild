/**
 * Rasgos de jugador de Football Manager 2024 (59 rasgos), con los nombres del
 * juego en español: los del desplegable «Cualidad de jugador» del foco de
 * contratación. El nombre anterior de la app queda en `old`.
 *
...
export interface TraitDef {
  id: string;
  /** Nombre del rasgo en el juego en español (desplegable «Cualidad de jugador» del foco de contratación). */
  es: string;
  /** Nombre que usaba antes la app. */
  old?: string;
  /** Otros nombres con los que puede aparecer en el juego. */
  aliases?: string[];
  /** No aparece en la lista del foco de contratación (se puede entrenar, no buscar). */
  notInFocus?: boolean;
  en: string;
...
export const TRAITS: TraitDef[] = [
  // ============================================================= Movimiento
  T({ id: "gets-forward", es: "Sube en cuanto puede", old: "Se incorpora al ataque siempre que puede", en: "Gets Forward Whenever Possible", category: "movimiento",
  ...
  T({ id: "stays-back", es: "Se queda siempre atrás", old: "Se queda atrás en todo momento", en: "Stays Back At All Times", category: "movimiento",
    needs: { Pos: 12, Ant: 11 },
  ...
  T({ id: "comes-deep", es: "Baja a recibir el balón", old: "Retrocede para recibir el balón", en: "Comes Deep To Get Ball", category: "movimiento",
  ...
  T({ id: "runs-ball-left", es: "Conduce el balón hacia la izquierda", old: "Conduce el balón por la banda izquierda", en: "Runs With Ball Down Left", category: "movimiento",
  ...
  T({ id: "runs-ball-right", es: "Conduce el balón hacia la derecha", old: "Conduce el balón por la banda derecha", en: "Runs With Ball Down Right", category: "movimiento",
    needs: { Acc: 12, Pac: 12, Agi: 12, Dri: 12 },
    ...
    good: [...EXTREMOS_ANCHOS, ...EXTREMOS_INTERIORES, ...LATERALES_ATQ],
    bad: [...CENTRALES, ...CONTENCION, ...REFERENCIAS, "P-A"] }),
  T({ id: "runs-ball-centre", es: "Conduce el balón hacia el centro", old: "Conduce el balón por el centro", en: "Runs With Ball Through Centre", category: "movimiento",
  ...
  T({ id: "runs-ball-often", es: "Corre con el balón a menudo", old: "Conduce el balón con frecuencia", en: "Runs With Ball Often", category: "movimiento",
  ...
  T({ id: "runs-ball-rarely", es: "Casi nunca corre con el balón", old: "Conduce el balón pocas veces", en: "Runs With Ball Rarely", category: "movimiento",
  ...
  T({ id: "cuts-inside-right", es: "Recorta hacia dentro desde la banda derecha", old: "Se mete hacia dentro desde la derecha", en: "Cuts Inside From Right Wing", category: "movimiento",
  ...
  T({ id: "cuts-inside-left", es: "Recorta hacia dentro desde la banda izquierda", old: "Se mete hacia dentro desde la izquierda", en: "Cuts Inside From Left Wing", category: "movimiento",
    needs: { Acc: 12, Agi: 12, Dri: 12 },
    conflicts: ["cuts-inside-both", "cuts-inside-right"], similarPI: ["cut-inside"], contrastPI: ["run-wide"],
    good: [...EXTREMOS_INTERIORES, "IWB-*"],
    bad: [...EXTREMOS_ANCHOS, "CWB-*", "WB-*", "FB-*"] }),
  T({ id: "cuts-inside-both", es: "Recorta hacia dentro desde ambas bandas", old: "Se mete hacia dentro desde ambas bandas", en: "Cuts Inside From Both Wings", category: "movimiento",
    needs: { Acc: 12, Agi: 12, Dri: 12 },
  ...
  T({ id: "gets-into-box", es: "Se mete en el área rival", old: "Se mete en el área rival siempre que puede", en: "Gets Into Opposition Area", category: "movimiento",
  ...
  T({ id: "arrives-late", es: "Llega desde segunda línea", old: "Llega tarde al área rival", en: "Arrives Late In Opponent's Area", category: "movimiento",
  ...
  T({ id: "beats-offside", es: "Le gusta romper el fuera de juego", old: "Intenta romper el fuera de juego", en: "Likes To Try To Beat Offside Trap", category: "movimiento",
  ...
  T({ id: "stays-inside-area", es: "No se mueve entre líneas", old: "Se queda dentro del área (no busca los espacios)", en: "Does Not Move Into Channels", category: "movimiento",
  ...
  T({ id: "moves-channels", es: "Se mueve entre líneas", old: "Busca los espacios entre líneas", en: "Moves Into Channels", category: "movimiento",
  ...
  T({ id: "knocks-ball-past", es: "Se intenta hacer autopases", old: "Lanza el balón por delante del rival", en: "Knocks Ball Past Opponent", category: "movimiento",
  ...
  // ============================================================= Pase
  T({ id: "killer-balls", es: "Intenta pases definitivos a menudo", old: "Intenta pases en profundidad a menudo", en: "Tries Killer Balls Often", category: "pase",
  ...
  T({ id: "no-through-balls", es: "No juega balones largos", old: "No intenta pases en profundidad", en: "Plays No Through Balls", category: "pase",
  ...
  T({ id: "plays-short-simple", es: "Da pases cortos y fáciles", old: "Da pases cortos y sencillos", en: "Plays Short Simple Passes", category: "pase",
  ...
  T({ id: "stops-play", es: "Para el juego", old: "Ralentiza el juego de vez en cuando", en: "Stops Play", category: "pase",
  ...
  T({ id: "dwells", es: "Ralentiza el juego", old: "Se entretiene con el balón", aliases: ["Juega el balón con el pie"], en: "Dwells On Ball", category: "pase", mentoringOnly: true,
    needs: { Ant: 12, Cmp: 12 }, contrastPI: ["hold-up-ball"],
    good: [],
    bad: ["*-*"] }),
  T({ id: "looks-for-pass", es: "Intenta el pase en vez de buscar el gol", old: "Prefiere pasar antes que tirar", en: "Looks For Pass Rather Than Attempting To Score", category: "pase",
  ...
  T({ id: "switches-play", es: "Le gusta cambiar el juego hacia las bandas", old: "Cambia el juego de banda", en: "Likes To Switch Ball To Other Flank", category: "pase",
  ...
  T({ id: "crosses-early", es: "Centra primero", en: "Crosses Early", category: "pase",
    needs: { Cro: 13, Vis: 11 },
    similarPI: ["cross-from-deep"], contrastPI: ["cross-from-byline"],
    good: ["FB-S", "FB-A", "WB-*", "CWB-*", "W-S", "WM-*", "DW-S", "WTF-S"],
    bad: [...EXTREMOS_INTERIORES, "IWB-*", "IFB-D", "WP-*"] }),
  ...
  // ============================================================= Tiro
  T({ id: "shoots-from-distance", es: "Lanzamientos desde lejos", old: "Tira desde lejos", en: "Shoots From Distance", category: "tiro",
  ...
  T({ id: "refrains-long-shots", es: "Evita realizar disparos lejanos", old: "Evita los tiros lejanos", en: "Refrains From Taking Long Shots", category: "tiro",
  ...
  T({ id: "shoots-with-power", es: "Dispara con potencia", old: "Tira con potencia", en: "Shoots With Power", category: "tiro",
  ...
  T({ id: "places-shots", es: "Coloca los tiros", old: "Coloca el tiro", en: "Places Shots", category: "tiro",
  ...
  T({ id: "first-time-shots", es: "Intenta tirar de primera", old: "Tira a la primera", en: "Attempts First Time Shots", category: "tiro",
  ...
  T({ id: "overhead-kicks", es: "Intenta hacer chilenas", old: "Intenta chilenas", en: "Attempts Overhead Kicks", category: "tiro",
    needs: { Fla: 14, Agi: 13, Fin: 12, Tec: 12 },
    good: ["P-A", "AF-A", "CF-*", "TF-A", "RMD-A"],
    bad: [...CENTRALES, ...CONTENCION, ...ORGANIZADORES] }),
  T({ id: "free-kicks-power", es: "Tira tiros libres con potencia", old: "Tira las faltas con potencia", en: "Hits Free Kicks With Power", category: "tiro",
    needs: { Fre: 13, Str: 12, Lon: 12 },
    conflicts: ["refrains-long-shots"], good: [], bad: [] }),
  T({ id: "long-range-free-kicks", es: "Intenta tiros libres desde lejos", old: "Intenta faltas desde lejos", en: "Tries Long Range Free Kicks", category: "tiro", gk: true,
    needs: { Fre: 14, Lon: 13 },
    conflicts: ["refrains-long-shots"], good: [], bad: [] }),

  // ============================================================= Defensa
  T({ id: "dives-into-tackles", es: "Entra con fuerza", old: "Se lanza a las entradas", en: "Dives Into Tackles", category: "defensa",
  ...
  T({ id: "stays-on-feet", es: "Mide sus entradas", old: "No se lanza a las entradas", en: "Does Not Dive Into Tackles", category: "defensa",
  ...
  T({ id: "marks-tightly", es: "Marca muy encima al rival", old: "Marca de cerca a los rivales", en: "Marks Opponent Tightly", category: "defensa",
  ...
  // ============================================================= Técnica
  T({ id: "brings-ball-out", es: "Saca el balón jugado de la defensa", old: "Sube con el balón desde la defensa", en: "Brings Ball Out Of Defence", category: "tecnica",
    needs: { Dri: 12, Ant: 11, Tec: 12, Cmp: 12 },
    good: ["BPD-*", "L-*", "WCB-S", "WCB-A", "IWB-*", "HB-D", "DLP-D"],
    bad: ["NCB-*", "NFB-D", "CD-St"] }),
  T({ id: "plays-way-out", es: "Intenta sacar el balón jugado", old: "Intenta salir jugando de situaciones comprometidas", en: "Tries To Play Way Out Of Trouble", category: "tecnica", mentoringOnly: true,
  ...
  T({ id: "tricks", es: "Intenta hacer maravillas", old: "Intenta trucos", en: "Tries Tricks", category: "tecnica",
  ...
  T({ id: "curls-ball", es: "Tira con efecto", old: "Da efecto al balón", en: "Curls Ball", category: "tecnica", mentoringOnly: true,
    needs: { Tec: 14 },
  ...
  T({ id: "outside-foot", es: "Usa el exterior del pie", en: "Uses Outside Of Foot", category: "tecnica",
    ...
    bad: ["NCB-*", "NFB-D", "BWM-*"] }),
  T({ id: "beats-man-repeatedly", es: "Le gusta regatear al rival una y otra vez", old: "Le gusta regatear repetidamente", en: "Likes To Beat Man Repeatedly", category: "tecnica",
    needs: { Dri: 14, Agi: 13, Tec: 12, Bal: 12 },
    good: ["W-A", "IW-A"],
    bad: [...CENTRALES, ...CONTENCION, ...ORGANIZADORES, ...REFERENCIAS, "P-A", "*-D", "AP-*"] }),
  T({ id: "ball-to-right-foot", es: "Pasa el balón al pie derecho antes de regatear", old: "Se pasa el balón a la pierna derecha antes de regatear", en: "Moves Ball To Right Foot Before Dribble Attempt", category: "tecnica",
    needs: { Dri: 12, Agi: 12 },
    conflicts: ["ball-to-left-foot"],
    good: ["IW-*", "IF-*"], bad: [] }),
  T({ id: "ball-to-left-foot", es: "Pasa el balón al pie izquierdo antes de regatear", old: "Se pasa el balón a la pierna izquierda antes de regatear", en: "Moves Ball To Left Foot Before Dribble Attempt", category: "tecnica",
    needs: { Dri: 12, Agi: 12 },
    conflicts: ["ball-to-right-foot"],
    good: ["IW-*", "IF-*"], bad: [] }),
  T({ id: "develop-weaker-foot", es: "Intenta mejorar la pierna mala", en: "Attempts To Develop Weaker Foot", category: "tecnica", gk: true, notInFocus: true,
    conflicts: ["avoids-weaker-foot"], good: ["*-*"], bad: [] }),
  T({ id: "avoids-weaker-foot", es: "Intenta no usar la pierna mala", old: "Evita usar la pierna mala", en: "Avoids Using Weaker Foot", category: "tecnica", gk: true,
    conflicts: ["develop-weaker-foot", "cuts-inside-both"], good: [], bad: [] }),
  T({ id: "long-flat-throw", es: "Lanza el balón largo y plano", old: "Saque de banda largo y raso", en: "Possesses Long Flat Throw", category: "tecnica",
    needs: { "L Th": 14, Str: 12 },
    good: ["FB-*", "WB-*", "CWB-*", "IWB-*", "NFB-D", "IFB-D"], bad: [] }),

  // ============================================================= Portero
  T({ id: "gk-long-throws", es: "Usa saques en largo para lanzar los contraataques", old: "Usa saques de mano largos para iniciar contraataques", en: "Uses Long Throws To Start Counter Attacks", category: "portero", gk: true, gkOnly: true,
    needs: { Thr: 13, Str: 11 },
    good: ["SK-*", "GK-D"], bad: [] }),
  ...
  T({ id: "winds-up", es: "Provoca al rival", old: "Provoca a los rivales", en: "Winds Up Opponents", category: "personalidad", gk: true, mentoringOnly: true, good: [], bad: ["*-*"] }),
];
...
const TRAIT_BY_NAME = new Map<string, TraitDef>(
  TRAITS.flatMap((t) => [t.es, t.en, ...(t.old ? [t.old] : []), ...(t.aliases ?? [])].map((n) => [norm(n), t] as [string, TraitDef])),
);

/** Rasgo por nombre del juego (español o inglés), aceptando el nombre anterior de la app. */
export function findTrait(name: string): TraitDef | null {
  return TRAIT_BY_NAME.get(norm(name)) ?? null;
}
