...
const FAMILY_OPTIONS: Record<StyleFamily, RoleOptionGroup[]> = {
  posesion: [
    ...
    g(DC, [o("BPD-D", "inicia el juego con el pase"), o("CD-D", "el compañero del central con salida: no arriesga"), o("CD-Co", "cobertura si la línea es alta y el otro sube a robar")], "uno con salida y otro sin florituras: dos con salida buscan el pase arriesgado a la vez"),
    ...
    g(MRL, [o("WM-S", "interior que combina y cubre"), o("W-S", "extremo que da la anchura"), o("WP-S", "organizador de banda si el lateral dobla")]),
    g(AMC, [o("AP-S", "organizador avanzado: el balón pasa por él"), o("AM-S", "mediapunta que combina y llega"), o("SS-A", "segundo delantero si el punta baja")]),
  ...
  presion: [
    ...
    g(DC, [o("BPD-D", "salida con criterio tras robar"), o("CD-D", "el sobrio junto al de salida"), o("BPD-St", "sale a robar por el lado de la presión"), o("CD-Co", "cobertura contra puntas rápidos")]),
  ...
  contra: [
    ...
    g(DC, [o("CD-D", "sobrio, sin riesgo"), o("BPD-D", "inicia la contra con el primer pase (mejor que Sin florituras)"), o("NCB-D", "solo en ligas bajas o con centrales de pie malo"), o("CD-Co", "cobertura contra puntas rápidos")]),
  ...
  directo: [
    ...
    g(DC, [o("CD-D", "sobrio"), o("NCB-D", "despeja y ya"), o("BPD-D", "si un central tiene pase largo: el lanzador"), o("WCB-S", "central abierto que conduce (Conte)")]),
...
const STYLE_OPTIONS: Record<string, RoleOptionGroup[]> = {
  "juego-posicion": [
    ...
    g(DC, [o("BPD-St", "stopper por el lado de la sobrecarga: roba pronto"), o("BPD-Co", "cobertura por el lado débil: recupera"), o("CD-D", "contra dos puntas: los dos en defender y sin Adelantarse (Exeter: central puro con pase corto)"), o("BPD-D", "salida sin subir la línea")], "un stopper y una cobertura; contra dos puntas, los dos en defender"),
    ...
    g(ST, [o("AF-A", "clava a los centrales para que no compriman (Exeter lo prefirió al Falso nueve)"), o("DLF-A", "04texag: retrasado en ataque"), o("DLF-S", "baja a enlazar"), o("F9-S", "solo con dos extremos que ataquen el hueco que deja")]),
  ],
  "cebar-presion": [
  ...
  relacionismo: [
    ...
    g(MRL, [o("WM-S", "interior con «Variar la posición»"), o("WP-S", "organizador de banda: la pared")]),
  ...
  "futbol-total": [
    ...
    g(DC, [o("L-S", "líbero en apoyo entre dos centrales de cobertura"), o("CD-Co", "los de cobertura"), o("BPD-Co", "cobertura con salida")], "un líbero y dos coberturas"),
    ...
    g(AMC, [o("AP-A", "organizador avanzado"), o("EG-S", "enganche"), o("AM-A", "llega")]),
  ...
  "presion-hombre": [
    ...
    g(DC, [o("BPD-D", "central con salida que se abre"), o("CD-D", "el que marca al hombre"), o("CD-St", "sale a por su par")]),
    ...
    g(DM, [o("HB-D", "medio escoba: forma la línea de tres"), o("DM-D", "si no hay medio escoba"), o("A-D", "solo cubre el +1")]),
  ...
  "gegenpress-vertical": [
    ...
    g(DC, [o("BPD-D", "salida vertical"), o("CD-D", "sobrio"), o("CD-Co", "cobertura contra puntas rápidos")]),
  ...
  "presion-dos-mediapuntas": [
    ...
    g(DC, [o("BPD-D", "el del medio: inicia el 3+2"), o("WCB-S", "los laterales de la línea de tres: se abren y conducen"), o("CD-D", "sobrio"), o("CD-Co", "cobertura si hay un punta rápido")], "central con salida en el medio y dos que se abren"),
  ...
  "control-directo": [
    ...
    g(DC, [o("CD-D", "con «Pases más directos»: licencia para el pase largo"), o("BPD-D", "el de salida corta"), o("CD-Co", "cobertura")], "uno con pase directo y otro con salida"),
  ...
  "rombo-pragmatico": [
    ...
    g(DC, [o("CD-D", "sobrio"), o("BPD-D", "salida"), o("CD-Co", "cobertura")]),
    ...
    g(MC, [o("CAR-S", "carrilero interior: da anchura desde el rombo"), o("MEZ-S", "interior que se abre"), o("B2B-S", "piernas"), o("CM-S", "enlace")], "un carrilero interior y un mezzala"),
    g(AMC, [o("AM-A", "el enganche que llega"), o("EG-S", "enganche puro"), o("SS-A", "segundo delantero"), o("AP-A", "creador que remata")]),
  ...
  cholismo: [
    ...
    g(MC, [o("CM-D", "mediocentro en defender"), o("B2B-S", "box-to-box"), o("BWM-S", "recuperador"), o("CM-S", "enlace")], "uno en defender y un box-to-box"),
    ...
    g(ST, [o("DLF-S", "delantero retrasado que enlaza"), o("AF-A", "el rápido"), o("P-A", "cazagoles"), o("PF-S", "presiona a los centrales")], "un retrasado y un rápido"),
  ],
  "contra-directo": [
    g(GK, [o("GK-D", "distribuye con rapidez"), o("SK-D", "si la línea es media")]),
    g(DC, [o("CD-D", "central en defender"), o("BPD-D", "con salida: mejor que Sin florituras, no devuelve el balón precipitadamente"), o("CD-Co", "cobertura contra puntas rápidos")], "un central puro y uno con salida"),
  ...
  reactivo: [
    ...
    g(DC, [o("CD-D", "con pase corto y «Tomar menos riesgos»"), o("BPD-D", "solo si el pie es muy bueno"), o("CD-Co", "cobertura")]),
    g(FB, [o("FB-S", "sube con criterio"), o("FB-D", "contra grandes: no se aventura"), o("WB-S", "contra inferiores")]),
    g(DM, [o("DM-D", "doble pivote de contención"), o("DLP-D", "el que saca el balón del doble pivote"), o("A-D", "ancla"), o("HB-D", "medio escoba")], "dos que no dejan espacio a la espalda"),
  ...
  "carrileros-directos": [
    g(GK, [o("GK-D", "clásico"), o("SK-D", "si tiene pie")]),
    g(DC, [o("WCB-S", "central abierto que conduce y saca el balón"), o("BPD-D", "el del medio: inicia"), o("CD-D", "sobrio"), o("CD-Co", "cobertura en el medio")], "el del medio sobrio o con salida; los de fuera, abiertos"),
  ...
  "bloque-bajo": [
    g(ST, [o("AF-A", "corre al espacio"), o("P-A", "cazagoles"), o("DLF-S", "aguanta"), o("TF-S", "referencia")]),
  ],
};
